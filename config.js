...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://i.postimg.cc/0235RpQ5/Theolegend.jpg";
...
module.exports = {
  ...
  packname: process.env.PACK_NAME || "T H E O",
  botname: process.env.BOT_NAME || "THEO-BOT",
